...
return [
    ...
    */
    ...
    'attributes' => [
        'RUC_EMPLEADOR' => 'RUC del Empleado',
        'RAZON_SOCIAL' => 'Razon Social',
        'TIPO_EMPRESA' => 'Tipo de Empresa',
        'DIRECC' => 'Direccion',
        'TELEFONO' => 'Telefono',
        'COD_ESTUDIO' => 'Codigo de Estudio',
        'CODIGO_EVENTO' => 'Codigo de Evento',
        'NUM_DEMANDA' => 'Num de Demanda',
        'NR_DEMANDA' => 'Nro de Demanda',
        'FE_EMISION' => 'Fecha de Emision',
        'CODIGO_UNICO_EXPEDIENTE' => 'Codigo Unico de Expediente',
        'FECHA_PRESENTACION' => 'Fecha de Presentacion',
        'NRO_EXPEDIENTE' => 'Nro de Expediente',
        'EXPEDIENTE' => 'Expediente',
        'AÑO' => 'Año',
        'SECRETARIO' => 'Secretario',
        'SECRETARIO_JUZGADO' => 'Secretario Juzgado',
        'JUZGADO' => 'Juzgado',
        'CODIGO_JUZGADO' => 'Codigo del Juzgado',
        'DESCRIPCION_JUZGADO' => 'Descripcion del Juzgado',
        'TOTAL_DEMANDADO' => 'Monto total Demandado',
        'MTO_TOTAL_DEMANDA' => 'Monto total de la Demanda',
        'TIPO_DEUDA' => 'Tipo de Deuda',
        'TIP_DEUDA' => 'Tipo de Deuda',
    ...
    // En el archivo resources/lang/es/validation.php
